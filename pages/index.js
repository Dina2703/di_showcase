      ...
      <main className="bg-[#d6e6da] md:pt-5 dark:bg-gray-700 px-6 relative">
        ...
        >
          ...
          <div className="flex flex-1 flex-col items-center justify-between h-full  py-5 mb-5">
            <div className="flex   items-center justify-center my-10 flex-col lg:flex-row-reverse   ">
              ...
              md:w-52 md:h-52 lg:w-72 lg:h-64  bg-avatar_bg border-2 border-teal-300 shadow-xl"
              >
                <Image
            ...
            <div>
              <Link
                ...
                offset={0}
                duration={1500}
                className="mx-auto mb-12  flex justify-center items-center bg-gradient-to-b from-teal-600 to-teal-500 rounded-full w-14 h-14 cursor-pointer hover:scale-110   ease-in-out duration-150 transition-all shadow-md "
              >
        ...
        <div className="">
          {backToTop && (
            <div
              className="
              fixed bottom-[60px] md:bottom-28 2xl:bottom-80 2xl:right-64 right-10 text-3xl 2xl:text-4xl cursor-pointer  hover:scale-110 ease-in-out duration-150 transition-all shadow-md mb-7 md:mb-0 bg-teal-500 p-2 w-12 h-12 rounded-md "
            >
              <button
                onClick={scrollUp}
        ...
        <div
          className="fixed bottom-[30px] md:bottom-14 2xl:bottom-40 2xl:right-64 right-10 text-3xl 2xl:text-4xl cursor-pointer  hover:scale-110 ease-in-out duration-150 transition-all shadow-md  bg-teal-500 p-2  rounded-md 
        "
        >
